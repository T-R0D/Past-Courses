...
va_list vap)
{
    extern HSim__s6 * createworkMdeecoder2__4__top__v(const char*);
    HSim__s6 *blk = createworkMdeecoder2__4__top__v(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createworkMdecoder__2__4(const char*);
    HSim__s6 *blk = createworkMdecoder__2__4(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","deecoder2_4_top_v", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("work","decoder_2_4", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("work","glbl", (HSimInstFactoryPtr)IF2);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMdeecoder2__4__top__v(const char*);
        topvl = (HSim__s5*)createworkMdeecoder2__4__top__v("deecoder2_4_top_v");
