...
va_list vap)
{
    extern HSim__s6 * createworkMproblem3__1__top__v(const char*);
    HSim__s6 *blk = createworkMproblem3__1__top__v(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createworkMproblem3__1(const char*);
    HSim__s6 *blk = createworkMproblem3__1(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","problem3_1_top_v", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("work","problem3_1", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("work","glbl", (HSimInstFactoryPtr)IF2);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMproblem3__1__top__v(const char*);
        topvl = (HSim__s5*)createworkMproblem3__1__top__v("problem3_1_top_v");
