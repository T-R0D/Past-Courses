...
// Global Constant Definitions
   ...
   const string SUB_TITLES =    " CASE |  WT TYPE  |  DISTANCE  |  TIME  |  SPEED  ";
...
/* Note to the Grader: when I first wrote this program, I wrote it to produce a table that
   was aesthetically pleasing to my standards. After consulting with the instructor, he
   told me that I should write the program to produce results like the example in the
   instructions for grading ease. Because of this, there may be lines of code that I turned into a comment
   rather than delete it and then wrote in functioning code that is likely more like what 
   you are likely expecting. My "extra" code should still follow class rules, therefore I
   would appreciate it if my grade was not discounted for it. -Terence                  */ 
    ...
    // input Data
       ...
       // get data for first test
          ...
          // print first test header
             // function: iostream <<
                cout << "Enter data for first test: " << endl;
          ...
          // get weight type for first test
             // function: iostream <<, >>
                ...
                cout << "     Enter first weight type: ";
                cin >> weight1;

          // get distance for first test
             // function: iostream <<, >>
                
                cout << "     Enter first distance moved: ";
                cin >> distance1;
...
printEndLines( ONE_LINE ); // Just separating the data entry prompts for aesthetic purposes
       ...
       // get data for second test
          ...
          // print second test header
             // function: iostream <<
                cout << "Enter data for second test: " << endl;

          // get test number for second test
             // function: promptForInt
                secondCase = promptForInt( "     Enter second test number: " );
                
          // get weight type for second test
             // function: promptForString
                weight2 = promptForString( "     Enter second weight type: " ); 

          // get distance for second test
             // function: promptForDouble
                distance2 = promptForDouble( "     Enter second distance moved: " );

          // get time for second test
             // function: promptForDouble
                time2 = promptForDouble( "     Enter second time period: " );  
