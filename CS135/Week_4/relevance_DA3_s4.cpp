...
// Global Constant Definitions
   ...
   const int PROMPT_BLOCK  = 45 ;
   const int OUT_BLOCK     = 35 ; 
...
Function Input/Parameters: inductance (double), frequency (double), 
                           lo_relev (double), ideal_relev (double), 
                           hi_relev (double)
Function Output/Parameters: none
Function Output/Returned: none 
Device Input: none
...
Dependencies: formatted command line I/O tools
*/
void printResultData( double frequency, double inductance, double lo_relev, 
                     double ideal_relev, double hi_relev) ;
...
int main()
   ...
   // calculate relevance
      ...
      // 50% relevance
         ...
         pct_relev = RELEV_LO ;
         lo_relev = calcRelevance( pct_relev, frequency, inductance ) ; 

      // 100% relevance
         // function: calcRelevance
         pct_relev = RELEV_IDEAL ;
         ideal_relev = calcRelevance( pct_relev, frequency, inductance ) ; 

      // 150% relevance
         // function: calcRelevance
         pct_relev = RELEV_HI ;
         hi_relev = calcRelevance( pct_relev, frequency, inductance ) ; 
   ...
   // output data
      ...
      // print numerical results
         ...
         printResultData( frequency, inductance, lo_relev, ideal_relev, hi_relev ) ;
