...
int main()
    ...
    */
    ...
    // Output line 1
    printStringAt( 20, 3, "*****", "LEFT" );

    // Output line 2
    printStringAt( 20, 4, "*****", "LEFT" );

    // Output line 3
    printStringAt( 20, 5, "*****", "LEFT" );

    // Print second box right justified at location 40
    // Output line 1
    printStringAt( 12, 3, "*****", "RIGHT" );

    // Output line 2
    printStringAt( 12, 4, "*****", "RIGHT" );

    // Output line 3
    printStringAt( 12, 5, "*****", "RIGHT" );

    // Print third box center justified at location 40
    // Output line 1
    printStringAt( 16, 7, "*****", "CENTER" );

    // Output line 2
    printStringAt( 16, 8, "*****", "CENTER" );

    // Output line 3
    printStringAt( 16, 9, "*****", "CENTER" );
