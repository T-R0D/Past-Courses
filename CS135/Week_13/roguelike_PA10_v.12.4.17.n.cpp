   ...
   // begin game loop
      ...
      while( keepPlaying )
        ...
        // manage player movement 
           // function: movePlayer
           movePlayer( difficulty, keepPlaying );
...
void XYPos ( int &xPos, int &yPos )
   {
    ...
    // Check if occupied
       ...
       cont = spaceOccupied(xPos, yPos, playMatrix[PLAY_AR_W][PLAY_AR_H]);
