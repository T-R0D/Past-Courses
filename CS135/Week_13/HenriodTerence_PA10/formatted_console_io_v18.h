...
/*
name: printSpecialCharAt
process: places character from extended character set at specified location
function input/parameters: x & y location (int), extended ASCII character code
                           to be output (unsigned short)
function output/parameters: none
function output/returned: none
device input: none
device output/monitor: places special character at specified location
dependencies: none
*/
void printSpecialCharAt( int xPos, int yPos, unsigned short charVal );
...
void printSpecialCharAt( int xPos, int yPos, unsigned short charVal )
   {
    // output the character
    mvaddch( yPos, xPos, A_ALTCHARSET + charVal );
