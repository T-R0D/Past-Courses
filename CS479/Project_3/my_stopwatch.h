...
@code
  ...
  stopwatch( 's', 0 ); // starts the first stopwatch

  time_passed = stopwatch( 'x', 0 ); // checks the time elapsed from the
                                     // first stopwatch call

  time_passed = stopwatch( 'c', 0 ); // also checks the time elapsed from the
                                     // first stopwatch call

  stopwatch( 's', 0 ); // re-starts the first stopwatch

  time_passed = stopwatch( 'z', 0 ); // checks the time elapsed from
