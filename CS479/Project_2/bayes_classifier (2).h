...
class BayesClassifier
{
 public:
  ...
  /*---   Mutators   ---*/
  void clear();
  void setMean( const Eigen::Vector2d& new_mean_vector );


  void setMean( const vector<DataItem>& data );
  ...
  void setCovariance( const vector<DataItem>& data,
                      const Eigen::Vector2d& mean );



  void setPriorProbability( const double new_probability );
  ...
  /*---   Common Utilities   ---*/
  static void performAnalysis( const string input_file,
                               const string output_file,
                               const vector<BayesClassifier>& classifiers );

  static string assignToClass( Eigen::Vector2d& input_vector,
