/**
    ...
    @brief Provides a functions for a "wall clock" stopwatch. Supports 10
           stopwatches simultaneously.    

    @version Original Code 1.00 (2/28/2014) - S
...
{
  // variables
//  double elapsed_seconds = 0; whole seconds not good for OS simulator
...
//  elapsed_seconds = (double)total_useconds / 1000000.0;
  ...
  return total_useconds; //elapsed_seconds;
}
